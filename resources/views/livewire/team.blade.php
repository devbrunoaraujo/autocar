<section id="about" class="py-16 bg-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <h2 class="text-3xl md:text-4xl font-bold text-steel-blue mb-4">Nossa Equipe de Vendas</h2>
            <p class="text-gray-600 text-lg">Profissionais especializados prontos para ajudar você</p>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-all">
                ...
                <p class="text-sm text-gray-500 mb-4">10+ anos de experiência</p>
                <button class=" mx-auto bg-green-600 hover:bg-green-500 text-white flex items-center gap-2 px-4 py-2 rounded-lg transition-colors">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-all">
                ...
                <p class="text-sm text-gray-500 mb-4">8+ anos de experiência</p>
                <button class=" mx-auto bg-green-600 hover:bg-green-500 text-white flex items-center gap-2 px-4 py-2 rounded-lg transition-colors">
                    <x-fab-whatsapp class="w-5 h-5"/>
                        Contatar
                </button>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-all">
                ...
                <p class="text-sm text-gray-500 mb-4">12+ anos de experiência</p>
                <button class=" mx-auto bg-green-600 hover:bg-green-500 text-white flex items-center gap-2 px-4 py-2 rounded-lg transition-colors">
                    <x-fab-whatsapp class="w-5 h-5"/>
                        Contatar
                </button>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-all">
                ...
                <p class="text-sm text-gray-500 mb-4">15+ anos de experiência</p>
                <button class=" mx-auto bg-green-600 hover:bg-green-500 text-white flex items-center gap-2 px-4 py-2 rounded-lg transition-colors">
                    <x-fab-whatsapp class="w-5 h-5"/>
                        Contatar
                </button>
