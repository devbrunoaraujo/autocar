<div>
    ...
    <div x-data class="text-center">
        <button @click="window.location.href='{{ route('estoque') }}'"
            class="bg-steel-blue hover:bg-steel-gray text-white font-bold py-4 px-8 rounded-lg text-lg transition-all transform hover:scale-105 shadow-lg">
